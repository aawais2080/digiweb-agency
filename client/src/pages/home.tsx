...
import heroBg from "/abstract_doodle_line_art_background_for_hero_section.webp";
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-3xl">
              <h1 className="text-5xl md:text-7xl font-bold text-foreground mb-6 leading-[1.1]">
                Transform your{" "}
                <span className="text-primary">digital ambitions</span> into
                reality.
              </h1>
              <p className="text-xl md:text-2xl text-muted-foreground mb-10 max-w-xl leading-relaxed">
                No magic, just concrete creative solutions. We build online
                success stories together with you..
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link href="/services">
                  <Button
                    size="lg"
                    variant="outline"
                    className="rounded-full text-lg px-8 h-14 border-2 hover:bg-white/50"
                  >
                    Our Services
                  </Button>
                </Link>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <Card
                  key={i}
                  className="border-none shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1 bg-white group cursor-pointer overflow-hidden"
                  ...
                  {[
                    {
                      ...
                      desc: "We immerse ourselves in your business and goals. Together we explore the best digital possibilities.",
                    },
                    {
                      step: "02",
                      title: "Navigation to success",
                      desc: "Using your goals as a starting point, we create a unique path. Creativity meets strategy.",
                    },
                    {
                      step: "03",
                      title: "Adventurous realization",
                      desc: "The moment plans become reality. We run through the process together to achieve your goals.",
                    },
                  ].map((item, i) => (
                    <div
                      key={i}
              ...
              <div className="bg-primary/5 rounded-[2rem] p-8 md:p-12 min-h-[500px] flex items-center justify-center relative">
                ...
                <div className="relative z-10 grid grid-cols-2 gap-4">
                  {[1, 2, 3, 4].map((n) => (
                    <div
                      key={n}
                      className="bg-white p-4 rounded-xl shadow-lg transform rotate-2 hover:rotate-0 transition-all duration-300"
                    >
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="order-2 lg:order-1 relative">
                ...
                <div className="bg-white border border-border p-8 rounded-[2rem] relative shadow-lg grid grid-cols-2 sm:grid-cols-3 gap-4">
                  {[
                    ...
                    { name: "Mike", role: "SEO" },
                    { name: "Lisa", role: "Marketing" },
                    { name: "Tom", role: "Video" },
                    { name: "Emma", role: "Strategy" },
                  ].map((person, i) => (
                    <div
                      key={i}
                      className="flex flex-col items-center p-4 rounded-xl hover:bg-background transition-colors"
              ...
              <div className="order-1 lg:order-2">
                ...
                <p className="text-muted-foreground mb-8 text-lg">
                  ...
                  field of online visibility and findability. We bundle our
                  forces and offer all expertise from a single point of contact.
                </p>
                <Link href="/team">
        ...
        <section className="py-24 bg-secondary/10">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl md:text-5xl font-bold text-foreground max-w-4xl mx-auto leading-tight">
              ...
              <span className="text-primary">clear agreements</span> without
              surprises."
            </h2>
            <div className="mt-12">
              <Link href="/process">
              ...
              <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <p className="text-white/70 mb-8 text-lg">
                    No magic, but concrete creative solutions that make you
                    shine online.
                  </p>
                  <Button
                    size="lg"
                ...
                <div className="hidden md:flex justify-end">
                  <div className="w-64 h-64 border-4 border-white/10 rounded-full flex items-center justify-center relative">
                    <div
                      className="absolute inset-0 border-4 border-dashed border-white/20 rounded-full animate-spin-slow"
